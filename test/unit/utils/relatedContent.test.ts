 ...
 */
export const registerRelatedContentTests = () => {
  quench?.registerBatch(
    ...
    (context: QuenchBatchContext) => {
      ...
      describe('filterRelatedEntries', () => {
        ...
        beforeEach(async () => {
          // Create a test setting (not setting as current to avoid side effects)
        ...
        afterEach(async () => {
          // Clean up test setting (this will also delete the entries)
          if (testSetting) {
        ...
        it('should filter UUIDs to only include those from the current compendium', async () => {
          ...
          await filterRelatedEntries(testSetting, added, removed, [Topics.Character]);
        ...
        it('should handle multiple topic filters', async () => {
          ...
          await filterRelatedEntries(testSetting, added, removed, [Topics.Character, Topics.Location]);
