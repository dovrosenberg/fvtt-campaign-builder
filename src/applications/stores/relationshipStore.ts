...
export const relationshipStore = () => {
  ...
  const extraFields = {
    [Topics.Character]: {
      ...
      [Topics.Location]: [{field:'role', header:'Relationship'}],
      [Topics.Organization]: [{field:'role', header:'Relationship'}],
      [Topics.PC]: [{field:'relationship', header:'Relationship'}],
    },
    [Topics.Location]: {
      [Topics.Character]: [{field:'role', header:'Relationship'}],
      [Topics.Location]: [{field:'relationship', header:'Relationship'}],
      [Topics.Organization]: [],
      [Topics.PC]: [{field:'role', header:'Relationship'}],
    },
    [Topics.Organization]: {
      [Topics.Character]: [{field:'role', header:'Relationship'}],
      [Topics.Location]: [],
