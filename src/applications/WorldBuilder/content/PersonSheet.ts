...
export class PersonSheet extends HandlebarsPartial<PersonSheet.CallbackType> implements TopicSheet  {
  static override _template = 'modules/world-builder/templates/PersonSheet.hbs';
...
// }
  ...
  public async getData(): Promise<PersonSheetData> {
  return {
    data: {}
  };
...
export namespace PersonSheet {
  export enum CallbackType {
  }
}

// export class PersonSheet extends HandlebarsP {
